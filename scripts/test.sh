...
sed -i '' "s/formn3hJtt8gvVKxpCfzCJGuoz6CNUFcULFZW18iTpC/Fg6PaFpoGXkYsidMpWTK6W2BeZ7FEfcYkg476zPFsLnS/" programs/bullistic-auction-house/src/lib.rs

# Anchor test will then execute the run-tests.sh script.
anchor test

# Swap program id back
sed -i '' "s/Fg6PaFpoGXkYsidMpWTK6W2BeZ7FEfcYkg476zPFsLnS/formn3hJtt8gvVKxpCfzCJGuoz6CNUFcULFZW18iTpC/" programs/bullistic-auction-house/src/lib.rs
